    ...
    MiroCommunity.Widget.prototype = function() {
        return {
            ...
            beforeLoad: function () {
                ...
                div.appendChild(ul);
                footer = MiroCommunity.createElement('a', {className: "mc-from", href: "http://" + this.opts.domain + '/'})
					
					footer.setAttribute('target', '_parent');
            ...
            beforeLoad_v2: function () {
                ...
                more_link = MiroCommunity.createElement('a', {href: "http://" + this.opts.domain + '/'});
					...
					more_link.setAttribute('target', '_parent');
